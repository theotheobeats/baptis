...
class Teacher extends Model
{
    ...
    public static function do_store(Request $request)
    {
        try {
            ...
            $teacher->created_by = UserInfoHelper::employee_id();
            $teacher->save();
    ...
    public static function do_update($id, Request $request)
    {
        try {
            ...
            if ($teacher == null) return ResponseHelper::response_error("Proses Ubah Gagal", "Data tidak ditemukan");

            // Jika ada, lanjut update data
            $teacher->name = $request->name;
            $teacher->phone = $request->phone;
            $teacher->updated_by = UserInfoHelper::employee_id();
            $teacher->save();
    ...
    public static function do_delete($id)
    {
        try {
            ...
            // Cek data ada di database
            if ($teacher == null) return ResponseHelper::response_error("Proses Hapus Gagal", "Data tidak ditemukan");

            // Jika ada, input data yang hapus
            $teacher->deleted_by = UserInfoHelper::employee_id();
