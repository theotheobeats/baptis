...
<head>
    ...
    <title>Surat Tunggakan SMP</title>
    <style>
        body {
...
<body>
    <div class="container">
        <table style="width: 100%; border: 0">
            <tr>
                ...
                <td style="width: 75%;">
                    <center>
                        <h3 style="margin-top: 0px; margin-bottom: 0px">YAYASAN PERGURUAN BAPTIS PALEMBANG</h3>
                        <h1 style="margin-top: 0px; margin-bottom: 0px">SMP BAPTIS</h1>
                        <h3 style="margin-top: 0px; margin-bottom: 0px">TERAKREDITASI “B”</h3>
                        <div style="font-size: 0.6rem;">
                            <p style="margin-bottom: 0px;">(NDS : 2011100016 NSS : 202 116 009 496 NPSN : 10609496)</p>
                            <p style="margin-bottom: 0px;">Jl. Jendral Sudirman No. 490 Km. 2,5 Telp. (0711) 5630607</p>
                            <p style="margin-bottom: 0px;">PALEMBANG - 30126</p>
                        </div>
                    </center>
                </td>
                <td style="width: 5%;"></td>
    ...
    <div class="container">
        <table style="width: 100%; border: 0">
            <tr>
                ...
                <td style="width: 50%; vertical-align: top; padding: 0;">
                    <table>
                        <tr>
                            <td style="width: 70%; padding: 2px; text-align: center">
        ...
        <table style="width: 100%; border: 0">
            <tr>
                <td style="width: 70%; vertical-align: top; padding: 0;">
                    <table>
                        <!-- <tr>
                            <td style="width: 20%; padding: 2px;">Nomor</td>
                            <td style="width: 80%; padding: 2px;">: </td>
                        </tr> -->
                        <tr>
                            <td style="width: 20%; padding: 2px;">Perihal</td>
                            <td style="width: 80%; padding: 2px;">: <b><u>Pemberitahuan Tertib Administrasi Uang Sekolah</u></b></td>
                        </tr>
                    </table>
                </td>
        ...
        <div style="margin-bottom: 10px">
            <p style="text-indent: 5%; margin-bottom: 8px">Dengan hormat,</p>
            <p style="text-align: justify;">Sehubungan dengan adanya laporan dari bendahara sekolah mengenai kewajiban uang sekolah yang belum di lunasi dari siswa tersebut diatas, maka dari itu melalui surat ini kami ingin mengingatkan kembali kepada bapak/ibu orang tua/wali murid berikut kewajiban administrasi uang sekolah dari {{ $student->name }}:</p>
        </div>

        <table class="border" style="padding: 0 20px;">
            <tr>
                <th style="text-align: center;">Keterangan Tunggakan</th>
            ...
            @endforeach
            <tr>
                <td class="grand-total" style="text-align: center;">Total Tunggakan Administrasi Sekolah</td>
        ...
        <div>
            <p style="text-align: justify;">Kami himbau bapak/ibu orang tua/wali murid untuk segera melunasi kewajiban uang sekolah tersebut tepat waktu, demi kelancaran proses belajar mengajar siswa di sekolah dan juga sebagai tertib administrasi di SMP Baptis Palembang.</p>
        </div>

        <br>

        <div>
            <p style="text-align: justify;">Demikianlah surat ini di sampaikan, atas perhatian dan kerjasamanya kami ucapkan terima kasih. </p>
        </div>
        ...
        <table style="width: 100%; border: 0">
            <tr>
                ...
                <td style="width: 30%;">
                    <p>Mengetahui,</p>
                    <p>Kepala SMP Baptis Palembang,</p>
                    <br><br><br><br>
                    <p><b><u>Teresia Diah Ekowati, S.Th.</b></u></p>
                </td>
            </tr>
        </table>
