...
<body>
    <div class="container">
            ...
            <tr>
                ...
                <td style="width: 60%;">
                    <center>
                        ...
                        <p>Telp. (0711) 311-238 | Web: www.sekolahbaptispalembang.com | Email:sdbaptis2015@gmail.com</p>
                    </center>
                </td>
        ...
        <center>
            ...
            <b style="margin: 0px;">Bukti Pembayaran Siswa</b>
                ...
                <td style="width: 50%; vertical-align: top; padding: 0;">
                    <table>
                        <tr>
                            ...
                            <td style="width: 65%; padding: 2px; color: #00b026;">Lunas</td>
                        </tr>
                        <tr>
                            <td style="width: 35%; padding: 2px;"><b>No. Pembayaran</b></td>
                            <td style="width: 65%; padding: 2px;">{{ $invoice_payment->code }}</td>
                        </tr>
                        <tr>
                            <td style="width: 35%; padding: 2px;"><b>Metode Pembayaran</b></td>
                            <td style="width: 65%; padding: 2px;">{{ $bank->name }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table>
            ...
            @foreach ($invoice_detail_payments as $invoice_detail_payment)
                <tr>
                    <td>{{ $i++ }}</td>
                    <td>{{ $invoice_detail_payment->due_name }} - {{ $invoice_detail_payment->invoice_detail_payment_for_month }} {{ $invoice_detail_payment->invoice_detail_payment_for_year }}</td>
                    <td style="text-align: right;">{{ number_format($invoice_detail_payment->price) }}</td>
                </tr>
            @php
                $grand_total += $invoice_detail_payment->price;
            @endphp
            @endforeach
            <tr>
                <td></td>
                <td class="grand-total">Grand Total</td>
                {{-- <td class="grand-total" style="text-align: right;">{{ number_format($invoice_payment->price) }}</td> --}}
        ...
        ?>
        {{-- <p><b>Terbilang</b> : <i><?= ucwords($data_helper->idr_currency_factory($invoice_payment->price)) ?></i></p> --}}
        ...
        <ul style="font-size: 10px;">
            ...
            <li>Uang yang sudah dibayar tidak dapat dikembalikan.</li>
