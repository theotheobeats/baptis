...
<body>
    <div class="container">
        <table style="width: 100%; border: 0">
            <tr>
                ...
                <td style="width: 75%;">
                    <center>
                        <h4 style="margin-top: 0px; margin-bottom: 0px">YAYASAN PERGURUAN BAPTIS PALEMBANG</h4>
                        <h1 style="margin-top: 0px; margin-bottom: 0px">SEKOLAH DASAR BAPTIS</h1>
                        <h4 style="margin-top: 0px; margin-bottom: 0px">TERAKREDITASI A ( AMAT BAIK )</h4>
                        <div style="font-size: 0.6rem;">
                            <p style="margin-bottom: 0px;">Jl. Jendral Sudirman No. 490 Km. 2,5 Sekip Jaya Telp. (0711) 311-238</p>
                            <p style="margin-bottom: 0px;">email: sdbaptis2015@gmail.com</p>
                            <p style="margin-bottom: 0px;">Notaris No. 85 Terdaf. Depkeh No. 11 Th. 1991</p>
    ...
    <div class="container">
        <table style="width: 100%; border: 0">
            <tr>
                <td style="width: 50%; vertical-align: top; padding: 0;">
                    <table>
                        <!-- <tr>
                            <td style="width: 35%; padding: 2px;">Nomor</td>
                            <td style="width: 55%; padding: 2px;">:SB/SD/III-2024</td>
                        </tr> -->
                        <tr>
                            <td style="width: 35%; padding: 2px;">Perihal</td>
                            <td style="width: 65%; padding: 2px;">: <b><u>SURAT HIMBAUAN TUNGGAKAN</u></b></td>
                        </tr>
                    </table>
                </td>
                <td style="width: 50%; vertical-align: top; padding: 0;">
        ...
        <div>
            <p>Kepada Yth,</p>
            <p><b>Bapak/Ibu Orang Tua/Wali Murid</b></p>
            <p><b>Dari murid a/n : {{ $student->name }}</b></p>
            <p><b>Kelas {{ $student->backtrack_current_classroom_name }}</b></p>
            <p>Di Tempat.</p>
        </div>
        ...
        <div>
            ...
            <p style="text-align: justify"><b>Melalui surat ini, kami ingin memberitahukan kepada Bapak/Ibu Orangtua Wali Murid dari : {{ $student->name }}. guna mengingatkan kembali mengenai tunggakan yang belum diselesaikan dengan rincian sebagai berikut : </b></p>
        </div>
        ...
        <p>{{ $i++ }}. Tunggakan <b>{{ $invoice_detail->due_name }}</b> Tahun Ajaran {{ $invoice_detail->payment_for_year }} sebesar : Rp{{ number_format($invoice_detail->price) }}</p>
        @endforeach

        <br>

        <div>
            <p style="text-align: justify;"><b><u>Oleh sebab itu, maka kami menghimbau agar Bapak/Ibu Orangtua Wali Murid  dapat dengan segera menyelesaikan administrasi sekolah yang tertunggak diatas.</b></u></p>
        </div>

        <div>
            <p style="text-align: justify;">Demikian surat himbauan ini kami buat. Atas perhatian dan pengertian Bapak/Ibu kami ucapkan banyak terima kasih.</p>
        </div>
        ...
        <table style="width: 100%; border: 0">
            <tr>
                ...
                <td style="width: 40%; position: relative">
                    <p>Palembang, {{ Carbon::now()->format('d F Y') }}</p>
                    <p>Kepala Sekolah SD Baptis,</p>
                    <br><br><br><br>
                    <p><u>Anggiat Rio Murbowo, S.Th,M.M, M.Pd</u></p>
                </td>
            </tr>
        </table>
