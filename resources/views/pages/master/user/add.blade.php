                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-4">
                                            ...
                                            <input class="form-control" id="txt-input-email" name="email" type="text" placeholder="Email" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-4">
                                            ...
                                            <input class="form-control" id="txt-input-username" name="username" type="text" placeholder="Username">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-4">
