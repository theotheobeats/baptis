                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-4">
                                            ...
                                            <input class="form-control" id="txt-input-grade" name="grade" type="text" placeholder="Tingkat Kelas" required>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-4">
                                            <label class="form-label" for="txt-input-school_group">Jenjang Kelas<span class="text-danger">*</span> (TK / SD / SMP)</label>
                                            <input class="form-control" id="txt-input-school_group" name="school_group" type="text" placeholder="Jenjang Kelas" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-4">
                                            ...
                                            <input class="form-control" id="txt-input-note" name="note" type="text" placeholder="Keterangan" required>
                                        </div>
                                    </div>
                                </div>
