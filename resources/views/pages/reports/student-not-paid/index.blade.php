    ...
    <div class="data-table-area">
        <div class="container-fluid">
            <div class="row g-4">
                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">
                                    ...
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Laporan Siswa Belum Bayar</li>
                                    </ol>
                                </h4>
                            </div>
                        </div>
                ...
                <form class="form theme-form" id="input-form" action="{{ url('/report/student-not-paid/print') }}" method="get" enctype="multipart/form-data">
                    <div class="col-12">
