        ...
        <tr>
            <td>
                <table width="100%">
                    ...
                    <tr>
                        <td style="font-size: 14px;">Dibuka oleh:</td>
    ...
    <tr>
        <td id="products">
            <table width="100%" class="product_row">
                ...
                <tr>
                    <td><span>{{ $cash_account->beginning_balance }}</span></td>
                </tr>
            </table>
        </td>
    </tr>
...
<script>
    ...
    if (type == "due-payment") {
        redirect_url = "{{ url('/transaction/due-payment') }}"
    } else {
        redirect_url = "{{ url('/finance/cashflow') }}"
    }
